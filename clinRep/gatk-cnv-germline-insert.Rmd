...
kpPlotRegions(kp, gainMat, col=gainMat$AFcol,data.panel = 1)
kpPlotRegions(kp, homlossMat, col=homlossMat$AFcol,data.panel = 2)
...
kpPlotRegions(kp, ACMGMat[which(ACMGMat$SVtype=="DUP")], col=ACMGMat$AFcolF,data.panel = 1)
kpPlotRegions(kp, ACMGMat[which(ACMGMat$SVtype!="DUP")], col=ACMGMat$AFcolF,data.panel = 2)
kpPlotMarkers(kp, data=genes, labels=genes$hgnc_symbol, text.orientation = "horizontal",
              r1=0.75, cex=0.5, adjust.label.position = FALSE)
```
