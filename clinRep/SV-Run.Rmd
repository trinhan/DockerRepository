...
#Get the genes of interest: cosmic or risk factor in cancer
CG1=unique(c(grep("cancer", S2$Pheno), grep("neoplasm", S2$Pheno)))
CG2=which(S2$MultiSpan[CG1]=="true")
CGenes=c(which(S2$Cosmic!="" & S2$MultiSpan=="true"), CG1[CG2])
...
```{r SV-Pathway}
PGenes=which(S2$GenesOfInterest!=""  & S2$MultiSpan=="true")
# label parameters to view by default
