...
kpPlotRegions(kp, gainMat2, col=gainMat2$AFcol,data.panel = 1)
kpPlotRegions(kp, lossMat2, col=lossMat2$AFcol,data.panel = 2)
...
```{r}
lx1=which((AnnotSV$GenesOfInterest!=""| AnnotSV$Cosmic!="") & AnnotSV$ACMG_class>=3 & (AnnotSV$AF<=0.1 | is.na(AnnotSV$AF)) & AnnotSV$MeanVAF>0.25)
Scolnames=c("SV_chrom", "SV_start", "SV_end","SV_type", "ACMG_class", "AF", "GT","MeanVAF",
            "GenesOfInterest","Cosmic", "Pathways","GTex", "Gene_name",  "Pheno")
T1=AnnotSV[lx1, Scolnames]
colnames(T1)=c("CHROM", "START", "END", "TYPE", "ACMG", "Pop Freq", "GT", "VAF", "GenesOfInterest", "Cosmic", "Pathways", "GTex", "Gene Names", "CLinVar Phenotypes")
