		...
		with open(inVcf, 'r') as reader:
			for line in reader:
				if line.startswith('##'):
					...
					pieces[format_idx] = 'GT:' + FORMAT +':AD:AF'
...
# The main argument parser
	...
	parser.add_argument("-VC", "--VariantCaller",help="Method for variant calling, will add output to INFO under ME in VCF. Strelka1: S1, Strelka2: S2", default="None")
